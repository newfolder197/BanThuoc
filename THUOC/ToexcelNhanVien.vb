Module ToexcelNhanVien


    Public Sub Export_to_Excel_NV(ByVal _DataSet As DataTable, ByVal _List_Col As String, ByVal Path As String)
        ...
        Try
            With Excel
                ...
                .cells(2, 3).value = "Giới Tính:True- Nam, Flase -Nữ"
